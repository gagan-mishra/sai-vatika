...
export function Footer() {
  return (
    <footer className="mt-20 border-t border-border/60 bg-panel">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:px-8 lg:grid-cols-4">
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-slate">Monday - Saturday: 9:00 AM - 8:00 PM</p>
